...
RSpec.describe GetAvailableSlotService::EntryPoint do
  ...
  let(:params) { { date: '2020-12-07', time_period: '2', address: 'street-10/7' } }
  ...
  context 'when booked time slots in different zones' do
    let(:params) { { date: '2020-12-07', time_period: '1', address: 'pushkina-street-12' } }
  ...
  context 'when there is no booked slots within the request parameters' do
    let(:params) { { date: '2020-12-07', time_period: '2', address: 'pushkina-street-12' } }
